...
This module contains all of the story narrative that sets the scene for
the player's adventure.

Each block of text has been declared as a variable. As the player chooses
different options in the story, their choice will identify which variable
(and which text) should be displayed to the player as they continue on their
adventure.
"""
...
NESTED_SPIDER_OPTIONS_TEXT = """
 ...
 double in size as it gets closer and you can clearly see a pair of fangs
